...
const VoiceRecorder = memo(({ onSendVoice, disabled = false }) => {
    ...
    return (_jsx(Button, { type: "button", variant: "outline", size: "icon", disabled: disabled, className: "rounded-full", onClick: startRecording, title: "Record voice message", children: _jsx(Mic, { className: "h-4 w-4" }) }));
});
